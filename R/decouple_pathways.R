...
#---- Header ----
"Mesothelioma AI Pipeline - Decouple Pathways

Usage: decouple_pathways.R [options]
...
Options:
  ...
  -n --top.n=<PATH>             Number of top associations to pull from PROGENy.
...
top.n     <- as.integer(arguments$top.n)
...
dir.create(outfolder, T, T) # Creates a directory based on the outfolder path provided
...
decouple_pathways(processed$normalized.counts, processed$deg, top.n, methods, do.split, outfolder)
